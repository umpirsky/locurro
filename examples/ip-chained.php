    ...
    new Locurro\Converter\Country(
        new Locurro\Converter\Locale(
            new Locurro\Converter\Currency(
                new Swap\Swap(
                    new Swap\Provider\ChainProvider([
                        new Swap\Provider\YahooFinanceProvider($httpAdapter = new Ivory\HttpAdapter\FileGetContentsHttpAdapter()),
                        new Swap\Provider\GoogleFinanceProvider($httpAdapter),
                        new Swap\Provider\WebserviceXProvider($httpAdapter)
                    ])
                )
            )
        )
